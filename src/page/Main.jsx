        ...
        <div class="" id="bottomPage">
            <Layout style={{ height: "100vh" }}>
                <Sider trigger={null} collapsible collapsed={collapsed}>
                    ...
                    >
                        {logIn ? (
                            <Button onClick={() => handleCompClick("/profile")} style={{ backgroundColor: "transparent", border: "none" }}>
                            <Avatar size="small" src="https://gravatar.com/avatar/205e460b479e2e5b48aec07710c08d50" />
                            </Button>
                        ) : (
                            <Button size="small" icon={<LoginOutlined />} onClick={()=>handleCompClick("profile")}/>
                ...
                <Modal title="Wellcome!! You are not signed in"
                    open={isModalOpen} onOk={handleOk} onCancel={handleCancel} width="150vh" height="1000vh" footer={[
